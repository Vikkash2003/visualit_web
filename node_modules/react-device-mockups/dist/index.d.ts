...
import Chromebook from './devices/Chromebook';
import GalaxyS3 from './devices/GalaxyS3';
...
import Pixel from './devices/Pixel';
import SamsungTV from './devices/SamsungTV';
import SurfacePro3 from './devices/SurfacePro3';
import SurfaceStudio from './devices/SurfaceStudio';
export default Device;
export { Device, Chromebook, GalaxyS3, GalaxyS5, GalaxyTab4, HTCOneM8, HuaweiP8, IMac, IPad, IPadAir2, IPadPro, IPhone6, IPhone6Plus, IPhoneSE, IPhone5, IPhone6Hand, IPhone7Hand, IPhone7Hand2, IPhone7, IPhoneX, Lumia930, Macbook, Macbook2015, MacbookPro, Pixel, SamsungTV, SurfacePro3, SurfaceStudio };
