        ...
        <html lang="en" className="h-full" suppressHydrationWarning>
            <body className="h-full bg-black text-white relative" suppressHydrationWarning>
                ...
                <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                    <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#1DB954]/15 rounded-full blur-3xl animate-pulse"></div>
                    ...
                    <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-green-600/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
                </div>
                {/* Content */}
