...
interface SparklesTextProps {
    ...
    /**
     * @default "{first: '#22c55e', second: '#15803d'}"
     * @type string
     * @description
...
const SparklesText: React.FC<SparklesTextProps> = ({
    text,
    colors = { first: "#22c55e", second: "#15803d" }, // Green 500 and Green 700
    className,
    sparklesCount = 10,
    ...props
}) => {
    ...
    return (
        ...
        >
            ...
            <span className={cn("relative z-10 text-6xl font-bold", className)}>{text}</span>
        </span>
    );
};
